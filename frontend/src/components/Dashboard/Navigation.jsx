...
const Navigation = () => {
    ...
    const handleLogout = async () => {
        try {
            await axios.post("http://localhost:8080/clients/logout",
                {
                    headers: {
                        'Authorization': token()
                    }
        ...
        <div className="nav">
                <div className="sidebar-header">
                    <a className="logo-wrapper">
                        ...
                        <h2 className="hidd logo">Client</h2>
                    </a>
                </div>
                ...
                <div className="sidebar-links">
                    ...
                    <NavLink className="link" to="/dashboard/commande">
                    ...
                    <NavLink className="link" to="/dashboard/reservation">
                    ...
                    <div className="user-profile">
                        ...
                        <div className="user-details hidd">
                            <Link className='username' to="/">
                                <Button className='-mt-3' variant='outline' onClick={handleLogout} >Se déconnecter</Button>
                            </Link>
                        </div>
                    </div>
                </div>
